    ...
    return (
        <div className="cell code-cell border border-border rounded-lg mb-4 bg-background">
            <div className="code-header bg-background-secondary px-4 py-2 border-b border-border">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <span className="font-medium text-primary-foreground">Code Cell: {definition.id}</span>
                        <button
                            onClick={onExecute}
                            className="flex items-center justify-center w-6 h-6 rounded bg-background border-border border-1 hover:bg-background-hover text-primary-foreground transition-colors"
                            title="Execute cell"
                        >
                        ...
                        {outputValues.map((value, index) => (
                            <div key={index} className="output-item">
                                {outputValues.length > 1 && (
                                    <div className="text-xs text-primary-foreground mb-1">#{index + 1}:</div>
                                )}
            ...
            {consoleOutput.length > 0 && (
                <div className="console-output bg-background text-primary-foreground px-4 py-3 border-t border-border">
