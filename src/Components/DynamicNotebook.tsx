  ...
  return (
    <div className="dynamic-notebook">
      <header>
        ...
        {/* Module status */}
        <details className="mb-4 text-sm text-primary-foreground">
          ...
          <div className="mt-2 ml-4 grid grid-cols-3 gap-2">
            {getAvailableModules().map(module => (
              <span 
                key={module} 
                className="inline-block bg-background-secondary text-primary-foreground rounded px-2 py-1 text-xs"
              >
                {module}
              </span>
            ))}
